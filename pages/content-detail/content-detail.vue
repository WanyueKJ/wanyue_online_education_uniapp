	...
	<view class="page">
		...
		<template v-else-if="type == 3">
			<view class="video-wrap3">
				...
				<video id="myVideo" :src="url" class="hidden" autoplay="true" @timeupdate="timeupdate" ref="video" @loadedmetadata="loadedmetadata"></video>
				<view class="slider-box">
					<text class="mm">{{start}}</text>
					<slider class="slider" @change="sliderChange" @changing="sliderChanging" block-size="28" :min="0" :max="duration"
